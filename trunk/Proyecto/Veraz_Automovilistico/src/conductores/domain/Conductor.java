package conductores.domain;

import java.util.Date;
import java.util.List;

import sistemaFinanciero.domain.DeudaSistemaFinanciero;
import sistemaJudicial.domain.ExpedienteJudicial;
import vehiculos.domain.Infraccion;
