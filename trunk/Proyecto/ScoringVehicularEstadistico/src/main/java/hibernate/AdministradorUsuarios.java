...
public class AdministradorUsuarios {
	...
	/*
	 * Obtiene un usuario, si la contrase�a y username son correctos
	 * 
	 * @param username del usuario a obtener y validar
	 * 
	 * @param pass contrase�a del usuario para obtener y validar
	 * 
	 * @return usuario con username
	 * 
	 ...
	 * 
	 * @return true si logra hacer la modificaci�n con exito
	 * 
	 * @return false si no
	 */
