							...
							<form name="frm_reclutamiento" action="" method="post">
								<table border="0" cellpadding="0" cellspacing="0" width="780" class="table_form">
									...
									<tr>
										...
										<td><span class="error" id="mail_error">La dirección de correo no es válida</span></td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										<td colspan="3">
											<label><input type="checkbox" autocomplete="off" name="acepto" id="acepto"/> Acepto los términos y condiciones  <a href="#" onClick='javascript:openPopupCenter("contrato.htm");'>(ver términos y condiciones)</a></label><br/>
										</td>
										<td><span class="error" id="acepto_error">Debe aceptar los términos y condiciones para continuar</span><br/></td>
									</tr>
									<tr>
